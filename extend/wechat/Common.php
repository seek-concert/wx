...
//        var_dump($this->appsecret);exit;
     ...
     * 使用数据库存储配置
     */
    protected function setConfigByDb()
    {
     ...
     * 直接赋值
     */
    protected function setConfigByCode()
    {
    ...
    protected function get_access_token(){
        ...
        cache('access_token', $this->access_token, 7000);
...
//        $chars = "abcdefghijklmnopqrstuvwxyz0123456789";
     ...
     * @return string
     */
     protected function arr2xml($data, $root = 'xml', $item = 'item', $id = 'id') {
        return "<{$root}>" .$this->_data_to_xml($data, $item, $id) . "</{$root}>";
    }

    protected function _data_to_xml($data, $item = 'item', $id = 'id', $content = '') {
   ...
   public function getAddress() {
     ...
     * @return bool|mixed
     */
    protected function httpsPost($url, $postdata, $ssl_cer = null, $ssl_key = null, $second = 30) {
        $ch = curl_init();
